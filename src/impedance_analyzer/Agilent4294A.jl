...
measurement).
"""
get_bandwidth(i::Instrument{Agilent4294A}) = i_query(i, "BWFACT?")
...
"""
function set_bandwidth(i::Instrument{Agilent4294A}, n)
...
"""
set_volt_ac(i::Instrument{Agilent4294A}, n::Voltage) = write(i, "POWE $(raw(n))"*"V")
...
"""
function get_impedance(ia::Instrument{Agilent4294A})
...
function perform_single_acquisition(ia::Instrument{Agilent4294A})
    write(ia, "HOLD")
    write(ia, "TRGS INT")
    write(ia, "SING")
    return nothing
...
"""
function set_measurement_to_complex(ia::Instrument{Agilent4294A})
    write(ia, "MEAS COMP")
    return nothing
end
...
|Z|: Impedance amplitude (absolute value)
  θ: Impedance phase
"""
function set_measurement_to_impedance_and_phase(ia::Instrument{Agilent4294A})
    write(ia, "MEAS IMPH")
    return nothing
end
...
function set_data_output_to_float32(ia::Instrument{Agilent4294A})
    write(ia, "FORM2")
    return nothing
end


function request_data_trace(ia::Instrument{Agilent4294A})
    write(ia, "OUTPDTRC?")
    return nothing
end


function get_data_header(ia::Instrument{Agilent4294A})
...
function read_num_bytes(ia::Instrument{Agilent4294A}, num_bytes)
